...
A learning website with dynamically added content in the dashboard, supporting hierarchical courses and rich-text lessons.
...
\*\*Security:\*\* \[Sessions, Oauth2 (google), CORS, CSRF (double submit cookie pattern)]  

\*\*Deployment:\*\* \[docker, private VPS]
...
\- Modular Angular project following Nx-style structure:

&nbsp; - \*\*Feature-based\*\*

&nbsp; - \*\*Shared modules\*\* for reusable components, pipes, and services

&nbsp; - \*\*Core module\*\* for global services and state management
